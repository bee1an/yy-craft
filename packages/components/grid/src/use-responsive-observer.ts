import type { UseEventListenerReturn } from '@yy-craft/composables/use-event-listener'
import type { UseResizeObserverReturn } from '@yy-craft/composables/use-resize-observer'
...
export function useResponsiveObserver<T extends string>(
  ...
  const responsiveConfig = computed(() => {
    ...
    const responsiveMap = valueMapStr.reduce(
      (pre, valueStr) => {
