import type { PopoverThemeVars } from '@yy-craft/theme-chalk/src/popover'
import type {
  ExtractPropTypes,
  PropType,
  RendererElement,
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const triggerClick = () => {
      if (props.trigger !== 'click' || entireVisible.value)
        return // hide动画未结束不能通过点击重新打开
