...
import { type ButtonType } from '@yy-craft/components'
import { ref } from 'vue'

const type = ref<ButtonType>('primary')
const dashed = ref(false)

const themeOverrides = ref({ buttonHeight: '40px' })
		...
		<yy-grid cols="2" :gap="10">
			<yy-card title="主要按钮">
				<yy-flex>
					...
					<yy-button type="info" strong>Strong</yy-button>
				</yy-flex>
			</yy-card>
			...
			<yy-card title="次要按钮">
				<yy-flex>
					...
					<yy-button secondary type="info" strong>Strong</yy-button>
				</yy-flex>
			</yy-card>
			...
			<yy-card title="次次要按钮">
				<yy-flex>
					...
					<yy-button tertiary type="info" strong>Strong</yy-button>
				</yy-flex>
			</yy-card>

			<yy-card title="次次次要按钮">
				<yy-flex>
			...
			<yy-card title="虚线按钮">
				<yy-flex>
					...
					<yy-button dashed type="info" strong>Strong</yy-button>
				</yy-flex>
			</yy-card>

			<yy-card title="修改主题">
				<yy-button :type="type" :dashed="dashed" :themeOverrides="themeOverrides"
					>修改主题</yy-button
				>
			</yy-card>
		</yy-grid>
