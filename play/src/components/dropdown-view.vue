		...
		<yy-grid cols="2" :gap="10">
			<yy-gi>
				<yy-flex vertical>
					...
					<yy-card title="不要箭头">
						...
						<yy-dropdown trigger="hover" :show-arrow="false" :options="basicMenuOptions">
					...
					<yy-card title="触发位置">
						...
						<div style="width: 50%">
							<yy-grid cols="3" :gap="10">
								...
								>
									<template v-if="item">
										<yy-dropdown :placement="item" trigger="hover" :options="basicMenuOptions">
			...
			<yy-gi>
				<yy-flex vertical>
					...
					<yy-card title="默认选中">
						<yy-p><yy-text code>selectedKeys</yy-text>配置菜单选中的key, 它是一个v-model</yy-p>
					...
					<yy-card title="二级菜单触发位置">
						...
						<yy-dropdown trigger="hover" sub-placement="bottom-start" :options="basicMenuOptions">
							<yy-button>悬浮</yy-button>
						</yy-dropdown>
					</yy-card>
					...
					<yy-card title="触发方式">
						...
						<yy-flex>
							...
							<yy-dropdown
								...
								:options="basicMenuOptions"
							>
								<yy-button @click="showDropdown = !showDropdown">手动</yy-button>
							</yy-dropdown>
						</yy-flex>
					</yy-card>
					...
					<yy-card title="层级">
						...
						<yy-dropdown trigger="hover" :z-index="1" :options="basicMenuOptions">
							<yy-button>悬浮</yy-button>
						</yy-dropdown>
					</yy-card>
					...
					<yy-card title="挂载位置">
						<yy-p
							>dropdown将默认挂载到body下,可以通过<yy-text code>to</yy-text>挂载到任意位置,
							传递<yy-text code>to=false</yy-text>将挂载到原位置</yy-p
						>

						<yy-dropdown trigger="hover" :to="false" :options="basicMenuOptions">
							<yy-button>悬浮</yy-button>
						</yy-dropdown>
					</yy-card>
				</yy-flex>
