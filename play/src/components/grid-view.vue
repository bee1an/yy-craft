...
const responsiveCols = computed(() => {
	return fixedSize.value ? 5 : responsiveSize.value ? '3 600:5 800:7 1000:9' : '3 s:5 m:7 l:9'
})
...
const responsiveSpan = computed(() => {
	return fixedSize2.value ? 1 : responsiveSize2.value ? '5 600:6 800:7 1000:8' : '0 s:3 m:4 l:5'
})
</script>
	...
	<div class="container_padding">
		...
		<yy-flex>
			...
			<yy-card title="响应式列数">
				<yy-flex vertical>
					<yy-flex>
						<yy-checkbox v-model="fixedSize" label="切换为固定尺寸"></yy-checkbox>
						<yy-checkbox v-model="responsiveSize" label="切换为元素尺寸响应"></yy-checkbox>
						<yy-checkbox v-model="screenResponsiveSize" label="切换为跟据窗口响应"></yy-checkbox>
					</yy-flex>
			...
			<yy-card title="响应式单元格">
				<yy-flex vertical>
					<yy-flex>
						<yy-checkbox v-model="fixedSize2" label="切换为固定尺寸"></yy-checkbox>
						<yy-checkbox v-model="responsiveSize2" label="切换为元素尺寸响应"></yy-checkbox>
						<yy-checkbox v-model="screenResponsiveSize2" label="切换为跟据窗口响应"></yy-checkbox>
					</yy-flex>
