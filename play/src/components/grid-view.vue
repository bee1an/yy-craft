  ...
  <div class="container_padding">
    ...
    <yy-flex>
      <yy-card title="基础使用">
        <yy-grid :cols="5" :gap="gap">
          <yy-grid-item :span="1" :row-span="2">
            <div class="darkgoldenrod h108" />
          </yy-grid-item>
          <yy-grid-item :offset="1">
            <div class="wheat h108" />
          </yy-grid-item>
          <yy-grid-item>
            <div class="darkgoldenrod h108" />
          </yy-grid-item>
      ...
      <yy-card title="响应式列数">
        <yy-flex vertical>
          <yy-flex>
            <yy-checkbox v-model="fixedSize" label="切换为固定尺寸" />
            <yy-checkbox v-model="responsiveSize" label="切换为元素尺寸响应" />
            <yy-checkbox
      ...
      <yy-card title="响应式单元格">
        <yy-flex vertical>
          <yy-flex>
            <yy-checkbox v-model="fixedSize2" label="切换为固定尺寸" />
            <yy-checkbox v-model="responsiveSize2" label="切换为元素尺寸响应" />
            <yy-checkbox
