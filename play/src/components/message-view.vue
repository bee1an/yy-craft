...
import { useMessage, A as YyA } from 'yy-craft'
  ...
  <div class="container_padding">
    ...
    <yy-grid cols="3" :gap="10">
      <yy-card title="基础使用">
        ...
        <yy-flex>
          <yy-button @click="message(randomText())">
            发送一条消息
          </yy-button>
      ...
      <yy-card title="自定义显示状态">
        ...
        <yy-flex>
          <yy-button @click="openMessage">
            打开
          </yy-button>
          <yy-button @click="closeMessage">
            关闭
          </yy-button>
        </yy-flex>
      </yy-card>
      ...
      <yy-card title="创建不同位置的消息">
        ...
        <yy-flex>
          ...
          <yy-button
            @click="message(randomText(), { placement: 'bottom-left' })"
          >
            左下
          </yy-button>
          <yy-button
            @click="message(randomText(), { placement: 'bottom-right' })"
          >
            右下
          </yy-button>
        </yy-flex>
