...
<template>
	<div class="container_padding">
		<yy-h1 prefix align-text>消息提示</yy-h1>
		<yy-grid cols="3" :gap="10">
			...
			<yy-card title="消息状态">
				...
				<yy-flex>
					<yy-button type="success" dashed @click="message.success('这是一条成功消息')"
						>成功</yy-button
					>
					<yy-button type="warning" dashed @click="message.warning('这是一条警告消息')"
						>警告</yy-button
					>
					<yy-button type="error" dashed @click="message.error('这是一条错误消息')">错误</yy-button>
					<yy-button type="info" dashed @click="message.info('这是一条通知消息')">通知</yy-button>
					<yy-button dashed @click="message.loading('加载中....')">加载</yy-button>
				</yy-flex>
			</yy-card>
			...
			<yy-card title="创建不同位置的消息">
				...
				<yy-flex>
					<yy-button @click="message(randomText(), { placement: 'top' })">默认(正上)</yy-button>
					<yy-button @click="message(randomText(), { placement: 'bottom' })">正下</yy-button>
					<yy-button @click="message(randomText(), { placement: 'top-left' })">左上</yy-button>
					<yy-button @click="message(randomText(), { placement: 'top-right' })">右上</yy-button>
					<yy-button @click="message(randomText(), { placement: 'bottom-left' })">左下</yy-button>
					<yy-button @click="message(randomText(), { placement: 'bottom-right' })">右下</yy-button>
				</yy-flex>
			</yy-card>
		</yy-grid>
	</div>
