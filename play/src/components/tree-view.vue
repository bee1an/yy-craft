...
function onLoad(treeNode: TreeOption) {
        ...
        <yy-flex vertical>
          ...
          <yy-card title="选中">
            <yy-p>
              设置<yy-text code>
                selectable=true
              </yy-text>后tree-node可选中
            </yy-p>
            <yy-p>
              设置<yy-text code>
                multiple=true
              </yy-text>后tree-node可多选
            </yy-p>
            <yy-tree
          ...
          <yy-card title="可拖动">
            ...
            <yy-tree :data="data3" draggable @drag="onDrag" />
          </yy-card>
        ...
        <yy-flex vertical>
          <yy-card title="设置别名">
            <yy-p>
              通过<yy-text code>
                value-field
              </yy-text>&<yy-text code>
                key-field
              </yy-text>设置value&key的别名
            </yy-p>
            <yy-tree :data="data2" value-field="xx" key-field="xxx" />
          </yy-card>
          ...
          <yy-card title="虚拟滚动">
            ...
            <yy-tree :data="data1" virtual-scroll />
          </yy-card>
        </yy-flex>
      </yy-gi>
    </yy-grid>
