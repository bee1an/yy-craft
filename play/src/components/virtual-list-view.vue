  ...
  <div class="virtual-list-test container_padding">
    ...
    <yy-grid cols="2" :gap="10">
      <yy-flex vertical>
        ...
        <yy-card title="滚动条">
          <yy-p
            >可以通过<yy-text code>scrollbar-props</yy-text>修改滚动条配置</yy-p
          >
        ...
        <yy-card title="手动滚动">
          ...
          <yy-flex vertical>
            <yy-flex>
              ...
              <yy-button
                @click="scrollTo({ distance: 1500, behavior: 'smooth' })"
              >
                平滑滚动到指定距离
              </yy-button>
              <yy-button @click="scrollTo({ index: 50 })"
                >滚动到指定index</yy-button
              >
              ...
              >
              <yy-button
                @click="scrollTo({ position: 'top', behavior: 'smooth' })"
              >
                平滑滚动到top
              </yy-button>
